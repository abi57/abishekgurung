...
const showUp = () => {
  document.getElementsByTagName("li")[0].style.left = "30px";
  document.getElementsByTagName("li")[1].style.left = "30px";
  document.getElementsByTagName("li")[2].style.left = "30px";
